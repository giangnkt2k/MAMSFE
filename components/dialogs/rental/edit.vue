...
export default {
  ...
  mounted () {
    EventBus.$on('OpenPopRentEdit', (val, clients, contractInfor, roomDetail) => {
  ...
  methods: {
    async handleSubmit () {
      ...
      // eslint-disable-next-line no-console
      console.log('clients', this.inforUser)
      // eslint-disable-next-line no-console
      console.log('contractInfor', this.constract.id)
      // eslint-disable-next-line no-console
      console.log('roomDetail', this.room)
